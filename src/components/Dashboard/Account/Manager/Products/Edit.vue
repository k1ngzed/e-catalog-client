      ...
      <div class="db_body__content__fixer">
        <div class="db_body__content__box box-parent">
          ...
          >
            ...
            <template v-if="form.colors !== undefined">
...
export default {
  ...
  computed: {
    ...mapGetters(["getProductById", "getCategoryList"])
  },
  methods: {
  ...
  mounted() {
    if ("productId" in this.$route.params) {
      let selectedAccount = this.getProductById(this.$route.params.productId)
      if (selectedAccount) this.form = selectedAccount
    }
  },
  created() {
